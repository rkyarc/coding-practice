/*
Exercise 0003 - Two Oldest Ages
---------------------------------------------------------
Task:
The two oldest ages function/method needs to be completed. It 
should take an array of numbers as its argument and return the 
...
// Arrow Function
export const twoOldestAges = (ages: number[]): number[] =>  [...ages].sort((a, b) => a - b).slice(-2)
